    ...
    <div class="d-flex"> <!-- DO NOT REMOVE - for flex items -->
        <div class="flex-shrink-0 p-3 border" style="width:280px; min-height:100vh;"> <!-- side panel-->
            ...
            <ul class="list-unstyled ps-0">
                ...
                <li class="mb-1">
                    <a href="/carriemart/admin/index.php"><button class="btn btn-toggle d-flex w-100 align-items-center rounded border-0"
                         aria-expanded="true">
                ...
                <li class="mb-1">
                    <a href="/carriemart/admin/accounts/index.php"><button class="btn btn-toggle d-flex w-100 align-items-center rounded border-0"
                        aria-expanded="false">
