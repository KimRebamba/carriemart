                    ...
                    <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            <div class="input-group input-group-sm" style="width:320px;">
                                ...
                                <input type="text" class="form-control" placeholder="Search return ID / order / status">
                            </div>
                            ...
                            <select class="form-select form-select-sm" aria-label="Sort by" style="width:180px;">
                                ...
                                <option value="refundHigh">Refund: High→Low</option>
                                <option value="refundLow">Refund: Low→High</option>
                            </select>
                        </div>
                        <div class="d-flex align-items-center gap-3">
                            <small class="text-muted">Showing 3 returns</small>
                            <a href="create.php" class="btn btn-primary btn-sm">Add Return</a>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>7001</td>
                                        <td>opened</td>
                                        <td><span class="status-badge ret-requested">requested</span></td>
                                        <td class="text-end">₱0.00</td>
                                        <td>—</td>
                                        <td><span class="small text-muted">2025-11-16</span></td>
                                        <td class="text-center actions-cell">
                                            <a href="view.php?id=501" class="btn btn-outline-primary btn-sm my-1">View</a>
                                            <a href="edit.php?id=501" class="btn btn-outline-secondary btn-sm">Edit</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>7002</td>
                                        <td>damaged</td>
                                        <td><span class="status-badge ret-approved">approved</span></td>
                                        <td class="text-end">₱450.00</td>
                                        <td><span class="small text-muted">2025-11-17 09:10</span></td>
                                        <td><span class="small text-muted">2025-11-16</span></td>
                                        <td class="text-center actions-cell">
                                            <a href="view.php?id=502" class="btn btn-outline-primary btn-sm my-1">View</a>
                                            <a href="edit.php?id=502" class="btn btn-outline-secondary btn-sm">Edit</a>
                                            <button class="btn btn-outline-danger btn-sm mb-1">Delete</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>7003</td>
                                        <td>other</td>
                                        <td><span class="status-badge ret-processed">processed</span></td>
                                        <td class="text-end">₱120.00</td>
                                        <td><span class="small text-muted">2025-11-15 14:22</span></td>
                                        <td><span class="small text-muted">2025-11-15</span></td>
                                        <td class="text-center actions-cell">
                                            <a href="view.php?id=503" class="btn btn-outline-primary btn-sm my-1">View</a>
                                            <a href="edit.php?id=503" class="btn btn-outline-secondary btn-sm">Edit</a>
                                            <button class="btn btn-outline-danger btn-sm mb-1">Delete</button>
                                        </td>
                                    </tr>
                                </tbody>
