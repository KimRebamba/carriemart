                    ...
                    <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            <div class="input-group input-group-sm" style="width:340px;">
                                ...
                                <input type="text" class="form-control" placeholder="Search product ID / name / model">
                            </div>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <small class="text-muted">Showing 3 products</small>
                            <a href="create.php" class="btn btn-primary btn-sm">Add Product</a>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>AlphaTech</td>
                                        <td>Mobiles</td>
                                        <td class="text-end">₱24,999.00</td>
                                        <td class="text-end">120</td>
                                        <td><span class="status-badge cond-new">new</span></td>
                                        <td><span class="status-badge prod-active">active</span></td>
                                        <td><span class="small text-muted">2025-11-10</span></td>
                                        <td class="text-center actions-cell">
                                            <a href="view.php?id=2001" class="btn btn-outline-primary btn-sm">View</a>
                                            <a href="edit.php?id=2001" class="btn btn-outline-secondary btn-sm">Edit</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>OmegaCorp</td>
                                        <td>Computers</td>
                                        <td class="text-end">₱54,500.00</td>
                                        <td class="text-end">35</td>
                                        <td><span class="status-badge cond-refurbished">refurbished</span></td>
                                        <td><span class="status-badge prod-active">active</span></td>
                                        <td><span class="small text-muted">2025-11-12</span></td>
                                        <td class="text-center actions-cell">
                                            <a href="view.php?id=2002" class="btn btn-outline-primary btn-sm">View</a>
                                            <a href="edit.php?id=2002" class="btn btn-outline-secondary btn-sm">Edit</a>
                                            <button class="btn btn-outline-danger btn-sm">Delete</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><span class="status-badge cond-used">used</span></td>
                                        <td><span class="status-badge prod-inactive">inactive</span></td>
                                        <td><span class="small text-muted">2025-11-14</span></td>
                                        <td class="text-center actions-cell">
                                            <a href="view.php?id=2003" class="btn btn-outline-primary btn-sm">View</a>
                                            <a href="edit.php?id=2003" class="btn btn-outline-secondary btn-sm">Edit</a>
                                            <button class="btn btn-outline-danger btn-sm">Delete</button>
                                        </td>
                                    </tr>
                                </tbody>
