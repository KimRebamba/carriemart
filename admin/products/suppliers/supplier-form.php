                    ...
                    <form class="needs-validation" method="post" novalidate>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="contact_number" name="contact_number" class="form-control" placeholder="+63">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-12">
                                <small class="text-muted">Only essential supplier details are shown.</small>
                            </div>
                        </div>
