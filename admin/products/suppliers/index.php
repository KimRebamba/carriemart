                    ...
                    <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            <div class="input-group input-group-sm" style="width:340px;">
                                ...
                                <input type="text" class="form-control" placeholder="Search supplier ID / name / contact">
                            </div>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <small class="text-muted">Showing 3 suppliers</small>
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>maria.reyes@gci.com</td>
                                        <td><span class="status-badge sup-active">active</span></td>
                                        <td><span class="small text-muted">2025-11-10</span></td>
                                        <td class="text-center actions-cell">
                                            <a href="view.php?id=3001" class="btn btn-outline-primary btn-sm my-1">View</a>
                                            <a href="edit.php?id=3001" class="btn btn-outline-secondary btn-sm">Edit</a>
