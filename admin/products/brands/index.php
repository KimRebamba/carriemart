                    ...
                    <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            <div class="input-group input-group-sm" style="width:340px;">
                                ...
                                <input type="text" class="form-control" placeholder="Search brand ID / name / website">
                            </div>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <small class="text-muted">Showing 3 brands</small>
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>5001</td>            
                                        <td>AlphaTech</td>
                                        <td><a href="https://alphatech.example" target="_blank" rel="noopener" class="small text-decoration-none">alphatech.example</a></td>
                                        <td><span class="status-badge brand-active">active</span></td>
                                        <td><span class="small text-muted">2025-11-10</span></td>
                                         <td class="text-center actions-cell">
                                            <a href="view.php?id=5001" class="btn btn-outline-primary btn-sm my-1">View</a>
