                    ...
                    <form class="needs-validation" method="post" novalidate enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="is_active" name="is_active" class="form-select">
                                    <option value="1" <?= (isset($brand['is_active']) && $brand['is_active'])?'selected':''; ?>>active</option>
                                    <option value="0" <?= (isset($brand['is_active']) && !$brand['is_active'])?'selected':''; ?>>inactive</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea id="description" name="description" class="form-control" rows="4"><?= htmlspecialchars($brand['description'] ?? '') ?></textarea>
                            </div>
