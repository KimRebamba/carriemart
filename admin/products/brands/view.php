                    ...
                    <form>
                         ...
                         <div class="row g-3">
                             ...
                             <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" value="<?= (isset($brand['is_active']) && $brand['is_active']) ? 'active' : 'inactive' ?>" disabled>
                             </div>
                         </div>
                         ...
                         <div class="d-flex gap-2 mb-3">
                            <a class="btn btn-primary btn-lg d-flex align-items-center justify-content-center gap-2 btn-icon"
                               style="flex: 2 1 0%;" href="brand-form.php?id=<?= urlencode($brand['brand_id'] ?? '') ?>">
                                Edit Brand
