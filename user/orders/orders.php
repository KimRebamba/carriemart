...
<head>
    ...
    @media (max-width: 768px) {
        .product-row {
            grid-template-columns: 1.6fr 1.1fr 90px 60px 160px;
            column-gap: .5rem;
        }
    }
            ...
            <div class="d-flex align-items-center gap-2">
                <button class="btn btn-outline-secondary btn-sm" type="button" data-bs-toggle="offcanvas"
                    ...
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" class="me-1" aria-hidden="true">
                        <path
                            d="M1.5 1.5h13a.5.5 0 0 1 .39.812L10 8v5.5a.5.5 0 0 1-.79.407l-2-1.333A.5.5 0 0 1 7 12.167V8L1.11 2.312A.5.5 0 0 1 1.5 1.5z" />
                    </svg>
                    Filters
                </button>
            ...
            <form class="vstack gap-3" method="get">
                ...
                <div>
                    ...
                    <select class="form-select" name="order_status">
                        ...
                        <option value="processing" <?php if($orderStatus==='processing') echo 'selected'; ?>>Processing
                        </option>
                        <option value="shipped" <?php if($orderStatus==='shipped') echo 'selected'; ?>>Shipped</option>
                        <option value="completed" <?php if($orderStatus==='completed') echo 'selected'; ?>>Completed
                        </option>
                        <option value="cancelled" <?php if($orderStatus==='cancelled') echo 'selected'; ?>>Cancelled
                        </option>
                    </select>
                </div>
                <div>
                    ...
                    <select class="form-select" name="payment_status">
                        <option value="">Any</option>
                        <option value="pending" <?php if($paymentStatus==='pending') echo 'selected'; ?>>Pending
                        </option>
                        <option value="paid" <?php if($paymentStatus==='paid') echo 'selected'; ?>>Paid</option>
                        <option value="refunded" <?php if($paymentStatus==='refunded') echo 'selected'; ?>>Refunded
                        </option>
                    </select>
                </div>
                <div>
                    <label class="form-label">Recipient</label>
                    <input type="text" class="form-control" name="recipient" value="<?php echo $recipient; ?>"
                ...
                <div>
                    ...
                    <input type="number" step="0.01" class="form-control" name="min_subtotal"
                        value="<?php echo $minSubtotal; ?>" placeholder="0.00">
                </div>
                <div class="d-grid">
                ...
                <div class="order-header">
                    <div class="order-left">
                        ...
                        <div class="order-actions">
                            ...
                            <a href="/carriemart/user/orders/order-form.php?id=<?php echo $o['order_id']; ?>"
                                class="btn btn-primary btn-sm">Edit Delivery Details</a>
                            <?php endif; ?>
                            <?php if ($o['order_status'] === 'completed'): ?>
                            <?php if (isset($o['has_return']) && $o['has_return']): ?>
                            <a href="/carriemart/user/returns/return-details.php?mode=view&order_return_id=<?php echo $o['return_id']; ?>"
                                class="btn btn-outline-info btn-sm">View Return (<?php echo $o['return_status']; ?>)</a>
                            <?php else: ?>
                            <a href="/carriemart/user/returns/create.php?order_id=<?php echo $o['order_id']; ?>"
                                class="btn btn-outline-secondary btn-sm">Return/Refund</a>
                            <?php endif; ?>
                            <?php endif; ?>
                            <?php if ($o['order_status'] === 'pending' || $o['order_status'] === 'processing'): ?>
                    ...
                    <div class="info-sections">
                            ...
                            <div class="product-list">
                                ...
                                <div class="product-row">
                                    ...
                                    <div class="product-actions">
                                        ...
                                        <?php if ($o['order_status'] === 'completed' || $o['order_status'] === 'returned' || $o['order_status'] === 'requested_refund'): ?>
                                        <?php if ((int)$ln['has_review'] === 1): ?>
                                        <a class="btn btn-outline-secondary btn-sm w-100 my-1"
                                            href="/carriemart/user/reviews/review-details.php?mode=edit&product_order_id=<?php echo $ln['product_order_id']; ?>">Edit
                                            Review</a>
                                        <?php else: ?>
                                        <a class="btn btn-outline-secondary btn-sm w-100 my-1"
                                            href="/carriemart/user/reviews/review-details.php?mode=add&product_order_id=<?php echo $ln['product_order_id']; ?>">Add
                                            Review</a>
                                        <?php endif; ?>
                                        <?php endif; ?>
                                    </div>
                        ...
                        <div>
                            ...
                            <div class="kv">
                                ...
                                <div class="v"><?php echo $o['delivery_recipient'] ? $o['delivery_recipient'] : '—'; ?>
                                </div>
                            </div>
                            <div class="kv">
                                <div class="k">Address</div>
                                <div class="v"><?php echo $o['delivery_address'] ? $o['delivery_address'] : '—'; ?>
                                </div>
                            </div>
                            <div class="kv">
                                <div class="k">Phone</div>
                                <div class="v"><?php echo $o['delivery_phone'] ? $o['delivery_phone'] : '—'; ?></div>
                            </div>
                        </div>
                        ...
                        <div class="split-two">
                            <div>
                                ...
                                <div class="kv">
                                    <div class="k">Payment Option</div>
                                    <div class="v"><?php echo $o['payment_option'] ? $o['payment_option'] : '—'; ?>
                                    </div>
                                </div>
                                <div class="kv">
                                    <div class="k">Payment Status</div>
                                    <div class="v"><?php echo paymentBadge($o['payment_status']); ?></div>
                                </div>
                                <div class="kv">
                                    <div class="k">Order Status</div>
                                    <div class="v"><?php echo statusBadge($o['order_status']); ?></div>
                                </div>
                                <?php if (isset($o['has_return']) && $o['has_return']): ?>
                                <div class="kv">
                            ...
                            <div>
                                ...
                                <div class="summary">
                                    <div class="line">
                                        <span>Subtotal</span><span><?php echo fmtPrice($o['subtotal']); ?></span></div>
                                    <div class="line"><span>Delivery
                                            Fee</span><span><?php echo fmtPrice($o['delivery_fee']); ?></span></div>
                                    <?php if ($o['percent_sale'] > 0): ?>
                                    <div class="line"><span>Discount
                                            (<?php echo $o['percent_sale']; ?>%)</span><span>-<?php echo fmtPrice($o['discount']); ?></span>
                                    </div>
                                    <?php endif; ?>
                                    <div class="line">
                                        <strong>Total</strong><strong><?php echo fmtPrice($o['total']); ?></strong>
                                    </div>
                                </div>
                            </div>
                        </div>
